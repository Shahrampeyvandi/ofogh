          ...
          <div class="row">
            ...
            <div class="form-group col-md-5">
              ...
              <select required name="type" class="form-control" id="type">
                ...
                <option value="محصول های دسته">لیستی از محصول های یک دسته بندی</option>
                <option value="محصول انتخابی">لیستی از محصول های انتخابی</option>
                <option value="لیست دسته بندی">لیستی از دسته بندی های انتخابی</option>
              </select>
            </div>
            <div class="form-group col-md-2">
              <label for="user_name" class="col-form-label"><span class="text-danger">*</span> پیشنهاد ویژه: </label>
              <div class="custom-control custom-switch">
                <input style="display:inline-block;" type="checkbox" class="custom-control-input" name="spechoffer"
                  id="sms_status">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-12" style="display:none;" id="service">
              ...
              <select name="service[]" id="servicelist" class="js-example-basic-single" dir="rtl" multiple>
                @foreach (\App\Models\Store\Product::orderBy('product_name','asc')->get() as $product)
            ...
            <tr>
              <td>
                <div class="custom-control custom-checkbox custom-control-inline" style="margin-left: -1rem;">
                  <input data-id="{{$appmenu->id}}" type="checkbox" id="{{$appmenu->id}}" name="customCheckboxInline1"
                    class="custom-control-input" value="{{$appmenu->id}}">
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('change','#type',function(){
     ...
     if(data === 'محصول انتخابی'){
            $('#categoryservice').hide()
            $('#store').hide()
            $('#service').show()
               }else if(data === 'لیست دسته بندی'){
        $('#categoryservice').hide()
        $('#store').show()
            $('#service').hide()
                        }else {
